...
--6b. Use JOIN to display the total amount rung up by each staff member in January of 2007. Use tables staff and payment.
/*
select * from staff limit 2;
select * from payment
where 
extract(year from payment_date) = 2007 and extract(month from payment_date) = 1
*/
SELECT
	s.first_name,
	s.last_name,
...
--select * from film_actor order by film_id limit 10;
...
----another way using subquery in WHERE clause------------------
...
---------------------------------Method 3: using 2 subqueries in nested loop-------------------------------------
--EXPLAIN --cost = 26.76
SELECT
	first_name,
	last_name
...
select * from film_category limit 4;
...
/* exploring tables
select * from film limit 5; film_id --> film_title
select * from payment limit 4;
select * from rental limit 5; --inventory_id
select * from customer limit 4;
select * from inventory limit 100; --inventory_id --> film_id
*/
...
/*exploring tables
select * from store limit 3;--store_id
select * from customer limit 2;--store_id, customer_id
select * from payment limit 2; --amount, customer_id
*/
...
select * from rental limit 3;--rental_id,inventory_id,customer_id
select * from payment limit 4; --amount,rental_id,customer_id
select * from category limit 2;--category_id, name-may be genre
select * from film_category limit 3; --film_id, category_id
select * from inventory limit 2; --inventory_id,film_id
select * from film limit 2;
*/
-------------------------method 1: Multiple joins------------------------------------
EXPLAIN -- cost:3532.82
SELECT
	c.name AS "Genre",
    --f.title,
